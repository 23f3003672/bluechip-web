  ...
  return (
    ...
    >
      <div className="grid w-full grid-cols-1 items-start gap-0 lg:grid-cols-2">
          ...
          {/* LEFT: TEXT CONTENT */}
          <div className="px-6 py-10 md:px-12 md:py-16 lg:ml-10 lg:px-20 lg:py-24">
            <h2
              id="about-us-title"
            ...
            <p className="mt-8 max-w-[520px] text-[14px] leading-[1.30] tracking-[0.004em] text-[#000000] sm:mt-12 md:text-[14px] lg:text-[16px]">
          ...
          <div className="relative flex items-center justify-center overflow-hidden px-4 py-4 md:px-12 md:py-8 lg:overflow-visible lg:px-20 lg:py-0 lg:-translate-y-[45px]">
            <div className="relative flex h-[370px] w-full items-center justify-center sm:h-[460px] lg:h-[550px]">
              <div className="relative left-[-35px] h-[550px] w-[400px] shrink-0 origin-center scale-[0.58] transition-transform sm:left-[-45px] sm:scale-[0.78] lg:left-[-60px] lg:scale-100">
