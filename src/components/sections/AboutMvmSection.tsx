...
>
  ...
  <div className="absolute top-3 right-3 flex items-center justify-center rounded-full bg-black/50 p-2 backdrop-blur-sm text-white transition-opacity hover:bg-black/70">
